...
{
    ros::init(argc, argv, "capra_co2_value_publisher");

    ros::NodeHandle nh;

    //ros::Publisher chatter_pub = nh.advertise<std_msgs::Int16>("/capra/co2_sensor", 1000);
    ros::Publisher chatter_pub = nh.advertise<std_msgs::String>("/capra/co2_sensor", 1000);
    
    ros::Rate loop_rate(1);
    std_msgs::String msg;
    //std_msgs::Int16 msg;

    ROS_DEBUG("Css %s", "cdscdsa");
